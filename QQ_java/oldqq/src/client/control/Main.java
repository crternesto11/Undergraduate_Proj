...
public class Main extends MainFrame
{
	...
	public void init()
	{
		new MyLabel(main_set,"../img/button/QQ_settings","png").addEvent();//给最底下的设置按钮添加事件
	...
	{
		main_state.removeAllItems();
		main_state.addItem(MyTools.getIcon("../img/status/status_online.png"));
		main_state.addItem(MyTools.getIcon("../img/status/status_qme.png"));
		main_state.addItem(MyTools.getIcon("../img/status/status_leave.png"));
		main_state.addItem(MyTools.getIcon("../img/status/status_busy.png"));
		main_state.addItem(MyTools.getIcon("../img/status/status_invisible.png"));
	}
	/**
	 * 初始化好友列表
	 */
	...
	public void startChat(ActionEvent e)
	{
		if(tree.getSelectionPath().getPathCount()==3)
		{
			...
			{	
				Chat chat=new Chat(friendIP,friendPort,friendName,this.main_username.getText());

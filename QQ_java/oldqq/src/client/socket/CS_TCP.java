...
public class CS_TCP extends TCP
{
	...
	public void doUsersInfo(String message)
	{
		...
		if(main!=null)
		{
			main.main_username.setText(userName);
			main.main_state.setSelectedIndex(userState);
			main.main_slogan.setText(signature);
			main.main_head.setIcon(MyTools.getIcon("../img/headImage/middle/"+headImage+"_64.jpg"));
		}
	}

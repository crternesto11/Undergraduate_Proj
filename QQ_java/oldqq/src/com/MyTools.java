...
public class MyTools
{
	...
	// 数据库地址和密码
	public static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/oldqq?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false&allowPublicKeyRetrieval=true";
	...
	public static void changeSkin()
	{
		try
		{
			UIManager.put("control", new Color(200, 221, 250, 255));//控件背景色

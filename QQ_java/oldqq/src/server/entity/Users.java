...
public class Users
{
	...
	public String toString(){
		return "id: "+id+",name: "+name+",pwd: "+pwd+",ip "+ip+",state:"+state
				+"gender: "+gender+",email: "+email+",lastLogin: "+lastLogin+",lastExit "+lastExit+",remarke:"+remarke
				+"signature: "+signature+",headImg: "+headImg+",type: "+type+",birthday:"+birthday;
	}

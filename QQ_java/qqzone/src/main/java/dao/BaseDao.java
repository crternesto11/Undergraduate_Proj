...
public class BaseDao {
    ...
    public static List queryRows(String sql, List<Object> params, Class cls) {
        ...
        try {
            ...
            // 得到查询的字段数量
            fieldNum = resultSetMetaData.getColumnCount();
            ...
            while (resultSet.next()) {
                ...
                for (int i = 1; i <= fieldNum; i++) {
                    ...
                    // 得到查询的每一个字段对应的值
                    // 通过invoke方法调用set方法
                    if(columnName.equals("u_id")){
                        method.invoke(object, resultSet.getObject("u_id"));
                    }
                    else if(columnName.equals("noteID")){
                        method.invoke(object, resultSet.getObject("noteID"));
                    }
                    else{

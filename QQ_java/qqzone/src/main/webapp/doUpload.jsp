    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="upload.jsp?userId=<%=user.getU_id()%>"><i class="glyphicon glyphicon-pencil"></i>&nbsp;发表个人志</a></li>
    ...
    <div class="col-md-9">
        ...
        这里是处理界面
            <%
                ...
                int rows=0;
                rows=userDao.InsertIntoNotes(title,content,user.getU_id());

               if(rows != 0){
                    request.setAttribute("login",user.getU_name());

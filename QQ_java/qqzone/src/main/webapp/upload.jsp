...
<div class="container">
    <div class="row-fluid">
        <div class="col-md-3">
            <div class="data_list">
                ...
                <%
                    Object userid=request.getParameter("id");

                    UserDao userDao=new UserDao();
                    User user=new User();
                    user=userDao.queryUserById(Integer.parseInt(userid.toString()));
                    int getuserid=Integer.valueOf(userid.toString());
                %>
    ...
    <div class="col-md-9">
        ...
        <div>
            <form action="doUpload.jsp?userid=<%=getuserid%>" method="post">
                ...
                <table style="margin-left:10%">
                    ...
                    <tr>
                        <td>文章内容：</td>
                        <td><textarea type="text" name="content" size="1000" style="margin: 0px; width: 399px; height: 581px;"></textarea></td>
                    </tr>

                </table>
                <input style="margin-left:25%" type="submit" value="发布"/>
            </form>

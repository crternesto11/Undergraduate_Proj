...
<%
    Object receive=request.getParameter("username");
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="font-size:25px" href="main"> QQ空间</a>
        </div>
                ...
                <%
                    ...
                    for(int i=0;i<NoteList.size();i++){%>
                        <li style="font-size: 25px;font-family: 楷体" id="<%=i%>">
                            <a href="detail.jsp?id=<%=Integer.toString(i)%>&username=<%=user.getU_name()%>">

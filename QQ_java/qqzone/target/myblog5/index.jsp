    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="upload.jsp?userId=<%=user.getUserId()%>"><i class="glyphicon glyphicon-pencil"></i>&nbsp;发表个人志</a></li>
...
<div class="container">
    <div class="row-fluid">
        <div class="col-md-3">
            <div class="data_list">
                ...
                <div class="userimg">
                    <img id="userimg" src="statics/images/b.png">
                </div>

                <div id="username" class="nick">
                    欢迎！
                    <%
                            out.write(user.getUname()+"<br/>");
                    %>
                </div>
    ...
    <div class="col-md-9">
        ...
        <div class="data_list">
            <div class="data_list_title"><span class="glyphicon glyphicon glyphicon-th-list">
            ...
            <div class="note_datas">
                <%
                    ...
                    NoteList=userDao.queryNotesById(user.getUserId());

                    for(int i=0;i<NoteList.size();i++){%>
                        <li style="font-size: 25px;font-family: 楷体" id="<%=i%>">
                            <a href="detail.jsp?id=<%=Integer.toString(i)%>">
